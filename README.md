...
[![Open to Work](https://img.shields.io/badge/Open%20to%20Work-Geospatial%20%7C%20Climate-2E9E6B?style=for-the-badge&logoColor=white)](#)
...
I'm a geospatial data scientist based in India with 3.5+ years of field and research experience. My background is in chemical engineering — the shift to geospatial science came through a genuine interest in how land, water, and energy systems interact at scale.

Most of my work has been in Tamil Nadu: classifying land use from satellite imagery, building multi-criteria suitability models, and delivering maps that feed into state-level planning decisions. I work end-to-end — from raw Sentinel-2 imagery to policy-ready outputs.
...
| **Machine Learning** | Python · Scikit-Learn · TensorFlow · Random Forest · U-Net · CNN |
